...
exports.GenericLinxDevice = __webpack_require__(3).GenericLinxDevice;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dist_linx_device_linx_device__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dist_linx_device_linx_device___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__dist_linx_device_linx_device__);

window.LinxDevice = __WEBPACK_IMPORTED_MODULE_0__dist_linx_device_linx_device__["LinxDevice"];
...
var LinxDevice = (function (_super) {
    __extends(LinxDevice, _super);
    function LinxDevice() {
        _super.call(this);
    }
    LinxDevice.prototype.open = function (connectionType, params) {
        var transport;
        switch (connectionType) {
            case 'http':
                ...
                this.transport = new http_transport_1.HttpTransportService(params.address, params.endpoint);
                break;
            default:
                return {
    ...
    LinxDevice.prototype.close = function () {
    };
    return LinxDevice;
}(linx_device_js_1.GenericLinxDevice));
...
var GenericLinxDevice = (function () {
    function GenericLinxDevice() {
        this.packetNumber = 0;
    }
    /**************************************************************************
    *   Device
    **************************************************************************/
     ...
     */
    GenericLinxDevice.prototype.sync = function () {
     ...
     */
    GenericLinxDevice.prototype.getDeviceId = function () {
        var _this = this;
     ...
     */
    GenericLinxDevice.prototype.getLinxApiVersion = function () {
        var _this = this;
     ...
     */
    GenericLinxDevice.prototype.getMaxBaudRate = function () {
        var _this = this;
     ...
     */
    GenericLinxDevice.prototype.setBaudRate = function (baudRate) {
        var _this = this;
     ...
     */
    GenericLinxDevice.prototype.setDeviceUserId = function (userId) {
     ...
     */
    GenericLinxDevice.prototype.getDeviceUserId = function () {
        var _this = this;
     ...
     */
    GenericLinxDevice.prototype.getDeviceName = function () {
        var _this = this;
    ...
    **************************************************************************/
     ...
     */
    GenericLinxDevice.prototype.digitalGetChans = function () {
        var _this = this;
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.digitalWrite = function (pinNumber, value) {
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.digitalWriteAdvanced = function (numPins, pinNumbers, values) {
     ...
     */
    GenericLinxDevice.prototype.digitalRead = function (pinNumber) {
        var _this = this;
     ...
     */
    GenericLinxDevice.prototype.digitalReadAdvanced = function (pinNumbers) {
        var _this = this;
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.digitalWriteSquareWave = function (channel, frequency, duration) {
    ...
    **************************************************************************/
     ...
     * @return Promise that resolves with an object containing a message, statusCode, and value
     */
    GenericLinxDevice.prototype.analogRead = function (pinNumber) {
        var _this = this;
        var commandParams = new Uint8Array(1);
        commandParams[0] = pinNumber;
     ...
     * @return Promise that resolves with an object containing a message, statusCode, and values array
     */
    GenericLinxDevice.prototype.analogReadAdvanced = function (pinNumbers) {
        var _this = this;
        var commandParams = new Uint8Array(pinNumbers);
        var packet = this.generatePacket(this.getPacketSize(commandParams), 100, commandParams);
        return new Promise(function (resolve, reject) {
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.analogWrite = function (pinNumber, value) {
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.analogWriteAdvanced = function (numPins, pinNumbers, values) {
        if (pinNumbers.length !== values.length) {
            new Promise(function (resolve, reject) {
                reject({ statusCode: 1, message: 'Invalid write' });
                return;
    ...
    **************************************************************************/
     ...
     */
    GenericLinxDevice.prototype.servoGetChannels = function () {
        var _this = this;
        var packet = this.generatePacket(this.getPacketSize(), 8);
        return new Promise(function (resolve, reject) {
            _this.sendPacketAndParseResponse(packet)
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.servoOpen = function (channels) {
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.servoSetPulseWidth = function (channel, value) {
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.servoSetPulseWidthAdvanced = function (numChans, channels, values) {
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.servoClose = function (channels) {
        var typedChannelNums = new Uint8Array(channels);
    ...
    **************************************************************************/
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.spiOpen = function (channel) {
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.spiSetBitOrder = function (channel, bitOrder) {
     ...
     */
    GenericLinxDevice.prototype.spiSetClockFrequency = function (channel, targetFrequency) {
        var _this = this;
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.spiSetMode = function (channel, mode) {
        if (mode < 0 || mode > 3) {
            return new Promise(function (resolve, reject) {
                reject({
                    statusCode: 1,
     ...
     */
    GenericLinxDevice.prototype.spiWriteRead = function (channel, csPin, csLogicLevel, data) {
     ...
     * @return Promise that resolves with an object containing a message, statusCode, and returnData
     */
    GenericLinxDevice.prototype.spiWriteReadAdvanced = function (channel, frameSize, csPin, csLogicLevel, data) {
        var _this = this;
    ...
    **************************************************************************/
     ...
     * @return Promise that resolves with an object containing a message and statusCode
     */
    GenericLinxDevice.prototype.i2cOpen = function (channel) {
        var typedChannelNum = new Uint8Array(1);
        typedChannelNum[0] = channel;
     ...
     * @return Promise that resolves with an object containing a message, statusCode, and actualFrequency
     */
    GenericLinxDevice.prototype.i2cSetSpeed = function (channel, frequency) {
        var _this = this;
     ...
     * @return Promise that resolves with an object containing a message, statusCode, and returnData
     */
    GenericLinxDevice.prototype.i2cRead = function (channel, slaveAddress, numBytesToRead, timeout, eofConfig) {
        var _this = this;
     ...
     * @return Promise that resolves with an object containing a message and statusCode
     */
    GenericLinxDevice.prototype.i2cWrite = function (channel, slaveAddress, eofConfig, data) {
     ...
     * @return Promise that resolves with an object containing a message and statusCode
     */
    GenericLinxDevice.prototype.i2cClose = function (channel) {
    ...
    **************************************************************************/
     ...
     * @return Promise that resolves with an object containing a message and statusCode
     */
    GenericLinxDevice.prototype.pwmSetDutyCycle = function (pinNumber, dutyCycle) {
     ...
     * @return Promise that resolves with an object containing a message and statusCode
     */
    GenericLinxDevice.prototype.pwmSetDutyCycleAdvanced = function (numPins, pinNumbers, dutyCycles) {
     ...
     * @return Promise that resolves with an object containing a message and statusCode
     */
    GenericLinxDevice.prototype.pwmSetFrequencyAdvanced = function (numPins, pinNumbers, frequencies) {
    ...
    **************************************************************************/
     ...
     */
    GenericLinxDevice.prototype.uartOpen = function (channel, baud) {
        var _this = this;
     ...
     * @return Promise that resolves with an object containing a message, the actual baud rate, and a statusCode
     */
    GenericLinxDevice.prototype.uartSetBaudRate = function (channel, baud) {
        var _this = this;
        var uartInfo = new Uint8Array(5);
        uartInfo[0] = channel;
        var adjustedBaud = this.numberAsByteArray(baud, 4);
     ...
     */
    GenericLinxDevice.prototype.uartGetBytesAvailable = function (channel) {
        var _this = this;
        var commandParams = new Uint8Array(1);
        commandParams[0] = channel;
     ...
     */
    GenericLinxDevice.prototype.uartRead = function (channel, numBytes) {
        var _this = this;
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.uartWrite = function (channel, data) {
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.uartClose = function (channel) {
        var typedChannelNum = new Uint8Array(1);
        typedChannelNum[0] = channel;
    ...
    **************************************************************************/
     ...
     */
    GenericLinxDevice.prototype.sendPacketAndParseResponse = function (packet) {
        var _this = this;
     ...
     * @return Packet size
     */
    GenericLinxDevice.prototype.getPacketSize = function (commandParams) {
     ...
     */
    GenericLinxDevice.prototype.generatePacket = function (packetSize, commandNumber, commandParams) {
     ...
     */
    GenericLinxDevice.prototype.numberAsByteArray = function (number, numBytes) {
     ...
     */
    GenericLinxDevice.prototype.generateChecksum = function (commandArray) {
        var checksum = 0;
     ...
     * @return Promise that resolves with an object containing a message and a statusCode
     */
    GenericLinxDevice.prototype.genericReturnHandler = function (packet) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.sendPacketAndParseResponse(packet)
                .then(function (data) {
    ...
    return GenericLinxDevice;
}());
exports.GenericLinxDevice = GenericLinxDevice;
var Return;
(function (Return) {
    ;
    ;
...
//# sourceMappingURL=generic-linx-device.js.map
